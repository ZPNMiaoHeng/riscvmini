...
object Const {
  ...
  // val PC_START = 0x200
  // val PC_EVEC = 0x100    // low locations of the trap vector 
...
// iaxi2apb
  ...
  val rs2 = Mux(wb_sel === WB_MEM && rs2hazard, regFile.io.wdata, Mux(wb_sel === WB_ALU && rs2hazard, ew_reg.alu, regFile.io.rdata2))
  // ALU operations
